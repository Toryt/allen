const { EMPTY_BIT_PATTERN, PRECEDES_BIT_PATTERN, MEETS_BIT_PATTERN, OVERLAPS_BIT_PATTERN } = require('./bitPattern')
...
module.exports = { VALUES, EMPTY, PRECEDES, MEETS, OVERLAPS, BASIC_RELATIONS }
