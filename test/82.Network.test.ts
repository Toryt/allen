  ...
  describe('instance methods', function () {
    ...
    describe('intersection ok', function () {
      ...
      it('fails for p(d)v, q(d)v', function () {
        console.log(`add('p', 'q') ${AllenRelation.AFTER.complement().toString()}`)
        this.subject.add('p', 'q', AllenRelation.AFTER.complement())
        ...
        console.log(`add('p', 'v') ${AllenRelation.DURING.toString()}`)
        this.subject.add('p', 'v', AllenRelation.DURING)
        console.log(`add('p ∩ v', 'p') ${toFirst.toString()}`)
        this.subject.add('p ∩ v', 'p', toFirst)
        console.log(`add('p ∩ v', 'v') ${toSecond.toString()}`)
        this.subject.add('p ∩ v', 'v', toSecond)
        console.log(`add('q', 'v') ${AllenRelation.DURING.toString()}`)
        this.subject.add('q', 'v', AllenRelation.DURING)
        console.log(`add('q ∩ v', 'q') ${toFirst.toString()}`)
        this.subject.add('q ∩ v', 'q', toFirst)
        console.log(`add('q ∩ v', 'v') ${toSecond.toString()}`)
